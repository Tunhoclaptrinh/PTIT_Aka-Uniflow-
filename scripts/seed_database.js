    ...
    const workflows = [
      ...
      // ── TRƯỜNG HỢP 1: CỤM PHÂN VÙNG GOM NHÓM SO GIÁ CƯỚC ────────────────
      {
        ...
        nodes: [
          ...
          },
          {
            ...
            data: { label: 'Xuất HĐĐT MISA meInvoice', description: 'Ký số VAT 1% — NĐ 117/2025 tự động', category: 'ACCOUNTING' },
          },
          {
            id: 'node_rate_notify',
            type: 'action',
        ...
        edges: [
          { id: 'e_rg_1-2',      source: 'node_rate_trigger',  target: 'node_rate_ai_sku',   animated: true, style: { stroke: '#ed1c24', strokeWidth: 2 }, data: { label: '⚡ Webhook Inbound' } },
          { id: 'e_rg_2-g1',    source: 'node_rate_ai_sku',   target: 'node_sub_vtp',        animated: true, style: { stroke: '#8B5CF6', strokeWidth: 2 }, data: { label: '📦 Kiện 350g' } },
          { id: 'e_rg_2-g2',    source: 'node_rate_ai_sku',   target: 'node_sub_ghtk',       animated: true, style: { stroke: '#8B5CF6', strokeWidth: 2 }, data: { label: '📦 Kiện 350g' } },
          { id: 'e_rg_2-g3',    source: 'node_rate_ai_sku',   target: 'node_sub_ghn',        animated: true, style: { stroke: '#8B5CF6', strokeWidth: 2 }, data: { label: '📦 Kiện 350g' } },
          // Edge nội bộ trong group
          { id: 'e_rg_g1-ai',   source: 'node_sub_vtp',       target: 'node_sub_ai_pick',    animated: true, style: { stroke: '#10B981', strokeWidth: 2 }, zIndex: 20, data: { isInternal: true, label: '💰 19.5k' } },
          { id: 'e_rg_g2-ai',   source: 'node_sub_ghtk',      target: 'node_sub_ai_pick',    animated: true, style: { stroke: '#10B981', strokeWidth: 2 }, zIndex: 20, data: { isInternal: true, label: '💰 22.0k' } },
          { id: 'e_rg_g3-ai',   source: 'node_sub_ghn',       target: 'node_sub_ai_pick',    animated: true, style: { stroke: '#10B981', strokeWidth: 2 }, zIndex: 20, data: { isInternal: true, label: '💰 24.5k' } },
          { id: 'e_rg_ai-pos',  source: 'node_sub_ai_pick',   target: 'node_rate_pos',       animated: true, style: { stroke: '#fcc20f', strokeWidth: 2 }, data: { label: 'Trừ tồn kho' } },
          { id: 'e_rg_ai-ship', source: 'node_sub_ai_pick',   target: 'node_rate_waybill',   animated: true, style: { stroke: '#10B981', strokeWidth: 2 }, data: { label: '🏆 Chốt Viettel Post' } },
          { id: 'e_rg_ship-misa',source: 'node_rate_waybill', target: 'node_rate_misa',      animated: true, style: { stroke: '#0070C0', strokeWidth: 2 }, data: { label: '🧾 Ký HĐĐT VAT 1%' } },
          { id: 'e_rg_misa-not', source: 'node_rate_misa',    target: 'node_rate_notify',    animated: true, style: { stroke: '#3B82F6', strokeWidth: 2 }, data: { label: '📲 Bắn tin ZNS & Telegram' } },
        ],
      ...
      // ── TRƯỜNG HỢP 2: CỤM PHÂN VÙNG GOM NHÓM ĐỒNG BỘ KHO PANCAKE POS ERP ──
      {
        ...
        nodes: [
          ...
          // GroupNode — style.width/height để ReactFlow render đúng kích thước
          {
            ...
            data: {
              ...
              subtitle: '⚡ Realtime Lock: Sapo + KiotViet + Nhanh.vn + MISA',
              childCount: 4,
              width: 600,
              height: 300,
              isExpanded: true,
        ...
        edges: [
          ...
          { id: 'e_pan_2-sapo',       source: 'node_pan_ai',      target: 'node_sub_sapo',     animated: true, style: { stroke: '#8B5CF6', strokeWidth: 2 }, data: { label: '⚡ Trừ Sapo' } },
          { id: 'e_pan_2-kiot',       source: 'node_pan_ai',      target: 'node_sub_kiotviet', animated: true, style: { stroke: '#8B5CF6', strokeWidth: 2 }, data: { label: '⚡ Trừ KiotViet' } },
          { id: 'e_pan_2-nhanh',      source: 'node_pan_ai',      target: 'node_sub_nhanh',    animated: true, style: { stroke: '#8B5CF6', strokeWidth: 2 }, data: { label: '⚡ Trừ Nhanh.vn' } },
          { id: 'e_pan_2-misa',       source: 'node_pan_ai',      target: 'node_sub_misa',     animated: true, style: { stroke: '#0070C0', strokeWidth: 2 }, data: { label: '🧾 Ký số MISA' } },
          // Edge nội bộ trong group
          ...
          { id: 'e_pan_ship-zalo',    source: 'node_pan_ship',    target: 'node_pan_zalo',     animated: true, style: { stroke: '#3B82F6', strokeWidth: 2 }, data: { label: '📲 Bắn tin Zalo ZNS' } },
        ],
        viewport: { x: 0, y: 0, zoom: 0.85 },
      ...
      // ── TRƯỜNG HỢP 3: CỤM GOM NHÓM XỬ LÝ HÀNG HOÀN & AI OCR ──────────────
      {
        ...
        edges: [
          ...
          { id: 'e_ret_ocr-aud',   source: 'node_sub_ocr',   target: 'node_sub_audit', animated: true, style: { stroke: '#8B5CF6', strokeWidth: 2.5 }, zIndex: 20, data: { isInternal: true } },
          { id: 'e_ret_cause-aud', source: 'node_sub_cause', target: 'node_sub_audit', animated: true, style: { stroke: '#8B5CF6', strokeWidth: 2.5 }, zIndex: 20, data: { isInternal: true } },
